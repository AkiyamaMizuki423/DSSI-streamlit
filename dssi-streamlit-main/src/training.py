...
def run(data_path):
    ...
    decision_tree = DecisionTreeClassifier(
        max_depth=appconfig.getint('Hyperparameters', 'dt_max_depth'),
        min_samples_split=appconfig.getint('Hyperparameters', 'dt_min_samples_split'),
        class_weight=appconfig.get('Hyperparameters', 'dt_class_weight'),
        random_state=appconfig.getint('Hyperparameters', 'dt_random_state'),
    )

    clf = Pipeline(steps=[("preprocessor", preprocessor),\
                          ("binary_classifier", decision_tree)
                         ])
